...
public class boggledTerraformingCheckEnabledIrradiatedProject extends BaseCommandPlugin
{
    protected SectorEntityToken entity;

    public boggledTerraformingCheckEnabledIrradiatedProject() {}

    public boggledTerraformingCheckEnabledIrradiatedProject(SectorEntityToken entity) {
        this.init(entity);
    }
