...
public class Boggled_AI_Mining_Drones extends BaseIndustry
{
    ...
    public boolean isAvailableToBuild()
    {
        ...
        if(boggledTools.getBooleanSetting("boggledStationConstructionContentEnabled") && boggledTools.getBooleanSetting("boggledEnableAIMiningDronesStructure") && this.market.getPrimaryEntity() != null && this.market.getPrimaryEntity().hasTag("station"))
        {
            return true;
        }
        else
